...
{//
    ...
    //private static string connectionString = ConfigurationManager.AppSettings["iMinutesConnString"];
        ...
        using (con)
        {
            ...
            while (reader.Read())
            {
                events.Add(new CalendarEvent() {
                    ...
                    start = Convert.ToString(reader["event_start"]),
                    end = Convert.ToString(reader["event_end"]),
