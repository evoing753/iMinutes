<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Aku_Login_Demo.aspx.cs" Inherits="Login_Demo" %>
...
<%--                                        <li><a href="chattest.aspx">線上會議</a></li>--%>
                        ...
                        <div class="login_form">
                            ...
                            <div class="pwdArea" id="pwdArea">
                                ...
                                <div class="inputOuter" id="pArea">
                                    <asp:TextBox ID="txtloginPasswd" runat="server" CssClass="inputstyle" TextMode="Password"></asp:TextBox>
                            ...
                            <span class="auto-style2" style="padding-top: 20px"><strong><a href="Aku_ForgetPasswd_Demo.aspx">忘記密碼？</a></strong></span>
                            <br />
                            <a href="AdminLogin.aspx">管理員</a></div>
                    </div>
                </div>
                ...
                <div class="qlogin" id="qlogin" style="display: none">
                    ...
                    <label for="upImage" class="input-tips2">圖片上傳：</label>
                	    <div class="inputOuter2" style="text-align:center">
                            ...
                            <fieldset>
                                <div class="inputArea">
                                    <asp:Button ID="btn新增" runat="server" OnClick="btn新增_Click" Style="margin-top: 10px; margin-left: 85px" CssClass="button_blue" Text="同意規範並註冊" />
                                    <a href="#" class="zcxy" target="_blank">註冊規範</a>
                                </div>
                            </fieldset>
                        </div>
                    </div>
        ...
        <div class="jianyi">*推薦使用CHROME瀏覽器訪問本站 </div>
