<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ForgetPasswd_Demo.aspx.cs" Inherits="ForgetPasswd_Demo" %>
            ...
            <section id="inner-headline">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                            <ul class="breadcrumb">
                                <li><a href="Home_Demo.aspx"><i class="fa fa-home">首頁</i></a><i class="icon-angle-right"></i></li>
                                <li><a href="Login_Demo.aspx"><i class="fa fa-sign-in">登入註冊</i></a><i class="icon-angle-right"></i></li>
            ...
            <div class="login aligncenter h4">
                <div class="web_login">
                    <div class="login_form">
                        <div class="h3 cue" style="color:red; font-weight:bolder; font-family:微軟正黑體">忘記密碼</div><br />
