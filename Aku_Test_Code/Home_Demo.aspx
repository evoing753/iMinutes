<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Home_Demo.aspx.cs" Inherits="Home_Demo" %>
...
<div id="wrapper">
            ...
            <div class="container">
              ...
              <div class="navbar-collapse collapse ">
                    <ul class="nav navbar-nav">
                        ...
                        <li><a href="Login_Demo.aspx">LOGIN/JOIN US</a></li>
                        <li>
                            <ul>
	...
	<div id="main-slider" class="flexslider">
	  <ul class="slides">
	  	<li> <img src="img/slides/1.jpg" alt="1.jpg"  /><!--圖片px需一致 不然會亂跳-->        
	    ...
	    <li> <img src="img/slides/2.jpg" alt="2.jpg" />
	      <div class="flex-caption" align="left">
	        <h3>導覽圖片2標題</h3>
	        	<p>1024 x 360</p>
	        <a href="#" class="btn btn-theme">了解更多</a> 
	    ...
	    <li> <img src="img/slides/3.jpg" alt="3.jpg" />
	      <div class="flex-caption" align="left">
	        <h3>導覽圖片3標題</h3>
	        	<p>1024 x 360</p>
	        <a href="#" class="btn btn-theme">了解更多</a> 
					...
					<div class="col-lg-3">
						<div class="box">
							<div class="box-gray aligncenter">
								<h4>時程功能大標題</h4>
								<div class="icon">
								<i class="fa fa-clock-o fa-3x"></i><!--icon變更 fa-開頭為icon css -->
								</div>
								<p>
								 功能文宣簡介
								</p>
