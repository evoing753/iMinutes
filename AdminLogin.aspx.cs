...
public partial class Login_Demo : System.Web.UI.Page
{
    ...
    {//
        ...
        //    Response.Redirect("~/Administrator/MemberList.aspx");
        //}
        ...
        ///////////
        Session [txtloginUser.Text] = user;
        ///////////

        
        if (txtloginUser.Text == "admin" && txtloginPasswd.Text == "admin" || txtloginUser.Text == "bhur7621@gmail.com" && txtloginPasswd.Text == "bhur7621"
            || txtloginUser.Text == "aiopjy@gmail.com" && txtloginPasswd.Text == "aiopjy" || txtloginUser.Text == "evoing753@gmail.com" && txtloginPasswd.Text == "evoing753"
            || txtloginUser.Text == "jacklau0428@gmail.com" && txtloginPasswd.Text == "jacklau0428" || txtloginUser.Text == "boxdog1222@gmail.com" && txtloginPasswd.Text == "boxdog1222")


        {
            
            Response.Write("<Script language='Javascript'>");
            Response.Write("alert('您好，管理員')");
            Response.Write("</" + "Script>");
            Response.AppendHeader("Refresh", "0;url=Administrator/MemberList.aspx");
            
        }
        else
        {
            Response.Write("<Script language='Javascript'>");
            Response.Write("alert('抱歉，您不是管理員')");
            Response.Write("</" + "Script>");
        }
